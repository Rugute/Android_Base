...
import ca.dalezak.android.base.utils.UIRunnable;

import java.util.LinkedList;

public abstract class Queue<T extends Task> implements Task.Callback<T, Model> {

    public interface Callback<T extends Task> extends Task.Callback<T, Model> {
    ...
    public void onTaskProgress(final T task, final Model model, final int total, final int progress) {
